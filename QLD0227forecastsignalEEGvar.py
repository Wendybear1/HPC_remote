...
# # ###forecast EEG var
# csv_reader = pd.read_csv('/fred/oz132/channels/PNES/channels/ACT0128_pure/Cz_EEGvariance_ACT0128_15s_3h.csv',sep=',',header=None)
...
# np.savetxt("cycles6hd0m72_Cz_forecast72hsignal_3hcycle_EEGvar_ACT0128_2022.csv", fore_arr_EEGvars, delimiter=",", fmt='%s')
...
# np.savetxt("activation_LSTM_Cz_EEGvar_ACT0128.csv", fore_arr_EEGvars, delimiter=",", fmt='%s')
...
# np.savetxt("cycles6h_Cz_forecast33hsignal_3hcycle_EEGvar_VIC2835.csv", fore_arr_EEGvars, delimiter=",", fmt='%s')


# from statsmodels.tsa.api import SARIMAX
# csv_reader = pd.read_csv('/fred/oz132/channels/PNES/channels/QLD1230_pure/Cz_EEGvariance_QLD1230_15s_3h.csv',sep=',',header=None)
# Raw_variance_EEG= csv_reader.values
# Raw_var_EEG_arr=[]
# for item in Raw_variance_EEG:
#     Raw_var_EEG_arr.append(float(item))
...
# np.savetxt("cycles6hd0m72_Cz_forecast78hsignal_3hcycle_EEGvar_QLD1230.csv", fore_arr_EEGvars, delimiter=",", fmt='%s')


from statsmodels.tsa.api import SARIMAX
csv_reader = pd.read_csv('/fred/oz132/channels/PNES/channels/VIC0829_pure/Cz_EEGvariance_VIC0829_15s_3h.csv',sep=',',header=None)
Raw_variance_EEG= csv_reader.values
Raw_var_EEG_arr=[]
for item in Raw_variance_EEG:
    Raw_var_EEG_arr.append(float(item))
...
np.savetxt("cycles6hm72_Cz_forecast81hsignal_3hcycle_EEGvar_VIC0829_2022.csv", fore_arr_EEGvars, delimiter=",", fmt='%s')
...
#     model_fit = model.fit()
#     fore_arr_EEGvars.append(model_fit.predict(450, 467))
# np.savetxt("cycles6hm72_Cz_forecast81hsignal_3hcycle_EEGvar_QLD0290_2022.csv", fore_arr_EEGvars, delimiter=",", fmt='%s')
...
#     model_fit = model.fit()
#     fore_arr_EEGvars.append(model_fit.predict(396, 413))
# np.savetxt("cycles12hm288_Cz_forecast78hsignal_3hcycle_EEGvar_VIC2031_2022.csv", fore_arr_EEGvars, delimiter=",", fmt='%s')
...
# np.savetxt("cycles12hm288_Cz_forecast63hsignal_3hcycle_EEGvar_NSW1402_2022.csv", fore_arr_EEGvars, delimiter=",", fmt='%s')
...
#     model_fit = model.fit()
#     fore_arr_EEGvars.append(model_fit.predict(432, 449))
# np.savetxt("cycles6hm360_Cz_forecast78hsignal_3hcycle_EEGvar_QLD2982_2022.csv", fore_arr_EEGvars, delimiter=",", fmt='%s')
