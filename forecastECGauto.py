...
# np.savetxt("cycles6hm72_ch31_forecast81hsignal_3hcycle_RRIauto_SA1243_2022.csv", fore_arr_EEGvars, delimiter=",", fmt='%s')


# csv_reader = pd.read_csv('/fred/oz132/seer_remote/ecg_data_result_PNES/RRI_ch31_rawauto_VIC0829_15s_3h.csv',sep=',',header=None)
# Raw_variance_EEG= csv_reader.values
# Raw_var_EEG_arr=[]
# for item in Raw_variance_EEG:
#     Raw_var_EEG_arr.append(float(item))
...
# np.savetxt("cycles6hm72_ch31_forecast81hsignal_3hcycle_RRIauto_VIC0829_2022.csv", fore_arr_EEGvars, delimiter=",", fmt='%s')
...
# np.savetxt("cycles5min_ch31_forecast33hsignal_3hcycle_RRIauto_VIC2835.csv", fore_arr_EEGvars, delimiter=",", fmt='%s')
...
# np.savetxt("activation_LSTM_ch31_RRIauto_QLD0290.csv", fore_arr_EEGvars, delimiter=",", fmt='%s')
...
#     model_fit = model.fit()
#     fore_arr_EEGvars.append(model_fit.predict(342, 359))
# np.savetxt("cycles24hd0_ch31_forecast81hsignal_3hcycle_RRIauto_QLD2307.csv", fore_arr_EEGvars, delimiter=",", fmt='%s')
...
# np.savetxt("cycles6hd0m144_ch31_forecast81hsignal_3hcycle_RRIauto_QLD3694.csv", fore_arr_EEGvars, delimiter=",", fmt='%s')
...
# np.savetxt("cycles12hm72_ch31_forecast63hsignal_3hcycle_RRIauto_NSW1402_2022.csv", fore_arr_EEGvars, delimiter=",", fmt='%s')
...
#     model_fit = model.fit()
#     fore_arr_EEGvars.append(model_fit.predict(306, 323))
# np.savetxt("cycles12hm216_ch31_forecast63hsignal_3hcycle_RRIvar_NSW1402_2022.csv", fore_arr_EEGvars, delimiter=",", fmt='%s')

# from statsmodels.tsa.api import SARIMAX
# csv_reader = pd.read_csv('/fred/oz132/channels/PNES/channels/NSW1402_pure/Cz_EEGauto_NSW1402_15s_3h.csv',sep=',',header=None)
# Raw_variance_EEG= csv_reader.values
# Raw_var_EEG_arr=[]
# for item in Raw_variance_EEG:
#     Raw_var_EEG_arr.append(float(item))
...
#     data = target_arr
#     my_order = (1, 0, 1)
#     my_seasonal_order = (1, 0, 1, 24*6*2)
#     model = SARIMAX(data, order=my_order, seasonal_order=my_seasonal_order)
#     model_fit = model.fit()
#     # print(model_fit.summary())
#     fore_arr_EEGvars.append(model_fit.predict(234, 251))
#
# np.savetxt("cycles24hd0m288_Cz_forecast63hsignal_3hcycle_EEGauto_NSW1402_2022.csv", fore_arr_EEGvars, delimiter=",", fmt='%s')
...
#     model_fit = model.fit()
#     fore_arr_EEGvars.append(model_fit.predict(450, 467))
# np.savetxt("cycles6hm216_ch31_forecast81hsignal_3hcycle_RRIauto_SA1243_2022.csv", fore_arr_EEGvars, delimiter=",", fmt='%s')
...
np.savetxt("cycles12hd0_ch31_forecast78hsignal_3hcycle_RRIauto_WA0305_2022.csv", fore_arr_EEGvars, delimiter=",", fmt='%s')