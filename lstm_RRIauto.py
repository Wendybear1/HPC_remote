...
csv_reader = pd.read_csv('/home/wxiong/seer_remote/ecg_data_result_PNES/RRI_ch31_rawauto_QLD1230_15s_3h.csv',sep=',',header=None)
...
np.savetxt("activation_LSTM_Ch31_RRIauto_QLD1230.csv", fore_arr_EEGvars, delimiter=",", fmt='%s')