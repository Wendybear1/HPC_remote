...
csv_reader = pd.read_csv('/fred/oz132/channels/PNES/channels/QLD1282_pure/Cz_EEGauto_QLD1282_15s_3h.csv',sep=',',header=None)
...
np.savetxt("cycles6hd0m72_Cz_forecast81hsignal_3hcycle_EEGauto_QLD1282_2022.csv", fore_arr_EEGvars, delimiter=",", fmt='%s')



# csv_reader = pd.read_csv('/fred/oz132/channels/PNES/channels/VIC0821_pure/Cz_EEGauto_VIC0821_15s_3h.csv',sep=',',header=None)
# Raw_variance_EEG= csv_reader.values
# Raw_var_EEG_arr=[]
# for item in Raw_variance_EEG:
#     Raw_var_EEG_arr.append(float(item))
...
#
# np.savetxt("cycles12hd0_Cz_forecast69hsignal_3hcycle_EEGauto_VIC0821_2022.csv", fore_arr_EEGvars, delimiter=",", fmt='%s')
...
#     fore_arr_EEGvars.append(model_fit.predict(450, 467))
#
# np.savetxt("cycles6hm72_Cz_forecast81hsignal_3hcycle_EEGauto_QLD0290_2022.csv", fore_arr_EEGvars, delimiter=",", fmt='%s')
...
#     long_rhythm_var_arr=movingaverage(var_arr,240*6)
#     long_var_plot = long_rhythm_var_arr[(240*6+240*3*k):(14400+240*3*k)]
#
#     phase_short_EEGvar_arr=long_var_plot
#     rolmean_short_EEGvar=phase_short_EEGvar_arr
#
...
#
# np.savetxt("cycles6h_Cz_forecast60hsignal_3hcycle_EEGauto_QLD3694_2022.csv", fore_arr_EEGvars, delimiter=",", fmt='%s')
...
#
# np.savetxt("cycles5min_Cz_forecast33hsignal_3hcycle_EEGauto_VIC2835.csv", fore_arr_EEGvars, delimiter=",", fmt='%s')
...
# #
# # np.savetxt("cycles24hd0m216_Cz_forecast63hsignal_3hcycle_EEGauto_NSW1402_2022.csv", fore_arr_EEGvars, delimiter=",", fmt='%s')
...
#
# np.savetxt("cycles6hm288_Cz_forecast78hsignal_3hcycle_EEGauto_QLD2982_2022.csv", fore_arr_EEGvars, delimiter=",", fmt='%s')
...
# np.savetxt("activation_LSTM_Cz_EEGauto_QLD0290.csv", fore_arr_EEGvars, delimiter=",", fmt='%s')
