...
#
# # from scipy import signal
# # x_detrended = signal.detrend(ch_notch)
# # ch_notch=x_detrended
# #
# # np.savetxt("Cz_EEG_QLD0481_15s_3h_detrend.csv", ch_notch, delimiter=",", fmt='%s')
#
...
#
# # np.savetxt("EEG_SA0124_3h_T3.csv", ch_notch, delimiter=",", fmt='%s')
...
# np.savetxt("T3_EEGvariance_NSW0352_15s_3h.csv", variance_arr, delimiter=",", fmt='%s')
# np.savetxt("T3_EEGauto_NSW0352_15s_3h.csv", value_arr, delimiter=",", fmt='%s')
# # np.savetxt("T3_EEGauto_lag1_SA0174_15s_3h.csv", value_arr, delimiter=",", fmt='%s')
...
#         if R[k] == R.max():
#             value_lag_arr.append(R[k+1])
# np.savetxt("/home/wxiong/seer_remote/eeg_data_result/channels/P4_EEGvariance_QLD0290_15s_3h.csv", variance_arr, delimiter=",", fmt='%s')
# np.savetxt("/home/wxiong/seer_remote/eeg_data_result/channels/P4_EEGauto_QLD0290_15s_3h.csv", value_arr, delimiter=",", fmt='%s')
...
#         if R[k] == R.max():
#             value_lag_arr.append(R[k+1])
# np.savetxt("/home/wxiong/seer_remote/eeg_data_result/channels/F7_EEGvariance_QLD0290_15s_3h.csv", variance_arr, delimiter=",", fmt='%s')
# np.savetxt("/home/wxiong/seer_remote/eeg_data_result/channels/F7_EEGauto_QLD0290_15s_3h.csv", value_arr, delimiter=",", fmt='%s')
#
...
#         if R[k] == R.max():
#             value_lag_arr.append(R[k+1])
# np.savetxt("/home/wxiong/seer_remote/eeg_data_result/channels/F8_EEGvariance_QLD0290_15s_3h.csv", variance_arr, delimiter=",", fmt='%s')
# np.savetxt("/home/wxiong/seer_remote/eeg_data_result/channels/F8_EEGauto_QLD0290_15s_3h.csv", value_arr, delimiter=",", fmt='%s')
# #
...
#         if R[k] == R.max():
#             value_lag_arr.append(R[k+1])
# np.savetxt("/home/wxiong/seer_remote/eeg_data_result/channels/T5_EEGvariance_QLD0290_15s_3h.csv", variance_arr, delimiter=",", fmt='%s')
# np.savetxt("/home/wxiong/seer_remote/eeg_data_result/channels/T5_EEGauto_QLD0290_15s_3h.csv", value_arr, delimiter=",", fmt='%s')
#
#
...
#         if R[k] == R.max():
#             value_lag_arr.append(R[k+1])
# np.savetxt("/home/wxiong/seer_remote/eeg_data_result/channels/T6_EEGvariance_QLD0290_15s_3h.csv", variance_arr, delimiter=",", fmt='%s')
# np.savetxt("/home/wxiong/seer_remote/eeg_data_result/channels/T6_EEGauto_QLD0290_15s_3h.csv", value_arr, delimiter=",", fmt='%s')
#
#
...
#         if R[k] == R.max():
#             value_lag_arr.append(R[k+1])
# np.savetxt("/home/wxiong/seer_remote/eeg_data_result/channels/O1_EEGvariance_QLD0290_15s_3h.csv", variance_arr, delimiter=",", fmt='%s')
# np.savetxt("/home/wxiong/seer_remote/eeg_data_result/channels/O1_EEGauto_QLD0290_15s_3h.csv", value_arr, delimiter=",", fmt='%s')
#
#
#
...
#         if R[k] == R.max():
#             value_lag_arr.append(R[k+1])
# np.savetxt("/home/wxiong/seer_remote/eeg_data_result/channels/O2_EEGvariance_QLD0290_15s_3h.csv", variance_arr, delimiter=",", fmt='%s')
# np.savetxt("/home/wxiong/seer_remote/eeg_data_result/channels/O2_EEGauto_QLD0290_15s_3h.csv", value_arr, delimiter=",", fmt='%s')
...
#             target_signal = list(raw_eeg._data[14])
#             channel_arr = channel_arr + target_signal
#             target_signal_2 = list(raw_eeg._data[15])
#             channel_arr_2 = channel_arr_2 + target_signal_2
#             target_signal_3 = list(raw_eeg._data[16])
...
#             channel_arr_6 = channel_arr_5 + target_signal_6
#
#
# ch_filtered = butter_bandpass_filter(channel_arr, 1, 30, 256, order=5)
# ch_notch = Implement_Notch_Filter(256, 5, 50, 3, 5, 'butter', ch_filtered)
...
#         if R[k] == R.max():
#             value_lag_arr.append(R[k+1])
# np.savetxt("/home/wxiong/seer_remote/eeg_data_result/channels/O2_EEGvariance_SA1243_15s_3h.csv", variance_arr, delimiter=",", fmt='%s')
# np.savetxt("/home/wxiong/seer_remote/eeg_data_result/channels/O2_EEGauto_SA1243_15s_3h.csv", value_arr, delimiter=",", fmt='%s')
#
#
# ch_filtered = butter_bandpass_filter(channel_arr_2, 1, 30, 256, order=5)
# ch_notch = Implement_Notch_Filter(256, 5, 50, 3, 5, 'butter', ch_filtered)
...
#         if R[k] == R.max():
#             value_lag_arr.append(R[k+1])
# np.savetxt("/home/wxiong/seer_remote/eeg_data_result/channels/O1_EEGvariance_SA1243_15s_3h.csv", variance_arr, delimiter=",", fmt='%s')
# np.savetxt("/home/wxiong/seer_remote/eeg_data_result/channels/O1_EEGauto_SA1243_15s_3h.csv", value_arr, delimiter=",", fmt='%s')
#
# ch_filtered = butter_bandpass_filter(channel_arr_3, 1, 30, 256, order=5)
# ch_notch = Implement_Notch_Filter(256, 5, 50, 3, 5, 'butter', ch_filtered)
# signal=ch_notch
...
#         if R[k] == R.max():
#             value_lag_arr.append(R[k+1])
# np.savetxt("/home/wxiong/seer_remote/eeg_data_result/channels/F7_EEGvariance_SA1243_15s_3h.csv", variance_arr, delimiter=",", fmt='%s')
# np.savetxt("/home/wxiong/seer_remote/eeg_data_result/channels/F7_EEGauto_SA1243_15s_3h.csv", value_arr, delimiter=",", fmt='%s')
#
# ch_filtered = butter_bandpass_filter(channel_arr_4, 1, 30, 256, order=5)
# ch_notch = Implement_Notch_Filter(256, 5, 50, 3, 5, 'butter', ch_filtered)
# signal=ch_notch
...
#         if R[k] == R.max():
#             value_lag_arr.append(R[k+1])
# np.savetxt("/home/wxiong/seer_remote/eeg_data_result/channels/F8_EEGvariance_SA1243_15s_3h.csv", variance_arr, delimiter=",", fmt='%s')
# np.savetxt("/home/wxiong/seer_remote/eeg_data_result/channels/F8_EEGauto_SA1243_15s_3h.csv", value_arr, delimiter=",", fmt='%s')
#
#
# ch_filtered = butter_bandpass_filter(channel_arr_5, 1, 30, 256, order=5)
# ch_notch = Implement_Notch_Filter(256, 5, 50, 3, 5, 'butter', ch_filtered)
...
#         if R[k] == R.max():
#             value_lag_arr.append(R[k+1])
# np.savetxt("/home/wxiong/seer_remote/eeg_data_result/channels/T6_EEGvariance_SA1243_15s_3h.csv", variance_arr, delimiter=",", fmt='%s')
# np.savetxt("/home/wxiong/seer_remote/eeg_data_result/channels/T6_EEGauto_SA1243_15s_3h.csv", value_arr, delimiter=",", fmt='%s')
#
#
# ch_filtered = butter_bandpass_filter(channel_arr_6, 1, 30, 256, order=5)
# ch_notch = Implement_Notch_Filter(256, 5, 50, 3, 5, 'butter', ch_filtered)
...
#         if R[k] == R.max():
#             value_lag_arr.append(R[k+1])
# np.savetxt("/home/wxiong/seer_remote/eeg_data_result/channels/T5_EEGvariance_SA1243_15s_3h.csv", variance_arr, delimiter=",", fmt='%s')
# np.savetxt("/home/wxiong/seer_remote/eeg_data_result/channels/T5_EEGauto_SA1243_15s_3h.csv", value_arr, delimiter=",", fmt='%s')
...
for m in range(len(channel)):
    channel_arr = []
    directory = r'/fred/oz132/DownloadEEG/QLD0481'
    dir_list = list(os.scandir(directory))
    dir_list.sort(key=lambda d: d.path)
    for entry in dir_list:
        if (entry.path.endswith(".csv")) and entry.is_file():
    ...
    index = [4976, 15642, 21651, 26941, 32448, 33810, 38639, 44069, 45230, 49534]  # QLD0481
...
df.to_csv("/fred/oz132/EEG_ML/15minpreictal/EEG_preictal_QLD0481.csv")

for i in range(len(data_pre_30min)):
    df[channel[i]] = data_pre_30min[i]
df.to_csv("/fred/oz132/EEG_ML/30minpreictal/EEG_preictal_QLD0481.csv")

for i in range(len(data_pre_45min)):
    df[channel[i]] = data_pre_45min[i]
df.to_csv("/fred/oz132/EEG_ML/45minpreictal/EEG_preictal_QLD0481.csv")

for i in range(len(data_pre_60min)):
    df[channel[i]] = data_pre_60min[i]
df.to_csv("/fred/oz132/EEG_ML/60minpreictal/EEG_preictal_QLD0481.csv")
...
for m in range(len(channel)):
    ...
    index = [402, 698, 4449, 5709, 5905, 10241, 11369, 16425, 17297]  # VIC1795
    # index = [3990, 4857, 6571, 15626, 18008, 21199, 28989, 29737, 35520]  # NSW0352
    #
    # index = [1020,1958,6712,9530,12549,13636,18130,20847,22055,22889,26682,28297,32575] # VIC0251 edf
    # index = [1440, 4840, 7397, 10079, 12304, 14471, 19460, 27346, 31581, 35983, 37739]  # SA0174
...
for i in range(len(data_pre_15min)):
    df[channel[i]] = data_pre_15min[i]
df.to_csv("/fred/oz132/EEG_ML/15minpreictal/EEG_preictal_VIC1795.csv")

for i in range(len(data_pre_30min)):
    df[channel[i]] = data_pre_30min[i]
df.to_csv("/fred/oz132/EEG_ML/30minpreictal/EEG_preictal_VIC1795.csv")

for i in range(len(data_pre_45min)):
    df[channel[i]] = data_pre_45min[i]
df.to_csv("/fred/oz132/EEG_ML/45minpreictal/EEG_preictal_VIC1795.csv")

for i in range(len(data_pre_60min)):
    df[channel[i]] = data_pre_60min[i]
df.to_csv("/fred/oz132/EEG_ML/60minpreictal/EEG_preictal_VIC1795.csv")