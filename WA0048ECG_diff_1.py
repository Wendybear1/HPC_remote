...
def Rpeakfunction(signal=None, sampling_rate=256, show=True):
    # check inputs
    if signal is None:
...
def correct_rpeaks(signal=None, rpeaks=None, sampling_rate=256, tol=0.05):
    if signal is None:
        raise TypeError("Please specify an input signal.")
...
def hamilton_segmenter(signal=None, sampling_rate=256):
    # check inputs
    if signal is None:
        raise TypeError("Please specify an input signal.")
...
np.savetxt("rawRRI_ch21_VIC0251_15s_3h.csv", RRI_arr31_arr, delimiter=",", fmt='%s')
np.savetxt("rawRRI_ch21_timearr_VIC0251_15s_3h.csv", t_arr31, delimiter=",", fmt='%s')
np.savetxt("RRI_ch21_timewindowarr_VIC0251_15s_3h.csv", t_window_arr, delimiter=",", fmt='%s')
np.savetxt("RRI_ch21_rawvariance_VIC0251_15s_3h.csv", variance_arr, delimiter=",", fmt='%s')
np.savetxt("RRI_ch21_rawauto_VIC0251_15s_3h.csv", value_arr, delimiter=",", fmt='%s')
np.savetxt("RRI_ch21_rawautolag1_VIC0251_15s_3h.csv", value_lag_arr, delimiter=",", fmt='%s')
...
# value_arr=[]
# variance_arr=[]
# directory = r'/fred/oz132/Download/TAS0058'
#
#
# target_signal_arr_ch1 = []
# target_signal_arr_ch2 = []
...
# subtract_3_1 = np.array(target_signal_arr_ch3) - np.array(target_signal_arr_ch1)
# subtract_2_1 = np.array(target_signal_arr_ch2) - np.array(target_signal_arr_ch1)
# # np.savetxt("rawEEG_ch31_TAS0058_15s_3h.csv", subtract_3_1, delimiter=",", fmt='%s')
#
# subtract_average=(subtract_2_1+subtract_3_1)/2
#
#
# signal = subtract_3_1
# # signal = np.array(target_signal_arr_ch2)
# divsignal_arr = split(signal, 256 * 15)
# rpeaks_31_arr = []
# for i in range(len(divsignal_arr)):
#         target_signal_arr = divsignal_arr[i]
...
#         t_window_arr.append(item[-1]/(256*3600))
#
# np.savetxt("new_rawRRI_ch31_TAS0058_15s_3h.csv", RRI_arr31_arr, delimiter=",", fmt='%s')
# np.savetxt("new_rawRRI_ch31_timearr_TAS0058_15s_3h.csv", t_arr31, delimiter=",", fmt='%s')
# np.savetxt("new_RRI_ch31_timewindowarr_TAS0058_15s_3h.csv", t_window_arr, delimiter=",", fmt='%s')
# np.savetxt("new_RRI_ch31_rawvariance_TAS0058_15s_3h.csv", variance_arr, delimiter=",", fmt='%s')
# np.savetxt("new_RRI_ch31_rawauto_TAS0058_15s_3h.csv", value_arr, delimiter=",", fmt='%s')
# np.savetxt("new_RRI_ch31_rawautolag1_TAS0058_15s_3h.csv", value_lag_arr, delimiter=",", fmt='%s')
...
#
#
# np.savetxt("rawRRI_ch31_QLD0290_15s_3h.csv", RRI_arr31_arr, delimiter=",", fmt='%s')
# np.savetxt("rawRRI_ch31_timearr_QLD0290_15s_3h.csv", t_arr31, delimiter=",", fmt='%s')
# np.savetxt("RRI_ch31_timewindowarr_QLD0290_15s_3h.csv", t_window_arr, delimiter=",", fmt='%s')
# np.savetxt("RRI_ch31_rawvariance_QLD0290_15s_3h.csv", variance_arr, delimiter=",", fmt='%s')
# np.savetxt("RRI_ch31_rawauto_QLD0290_15s_3h.csv", value_arr, delimiter=",", fmt='%s')
# np.savetxt("RRI_ch31_rawautolag1_QLD0290_15s_3h.csv", value_lag_arr, delimiter=",", fmt='%s')
