...
#     data = target_arr
#     my_order = (1, 0, 2)
#     my_seasonal_order = (1, 0, 2, 144)
#     model = SARIMAX(data, order=my_order, seasonal_order=my_seasonal_order)
#     model_fit = model.fit()
#     fore_arr_EEGvars.append(model_fit.predict(414, 431))
# np.savetxt("newpar144p1d0q2_ch21_forecast75hsignal_3hcycle_RRIauto_VIC1012.csv", fore_arr_EEGvars, delimiter=",", fmt='%s')


# # from statsmodels.tsa.api import SARIMAX
# ###forecast EEG var
# csv_reader = pd.read_csv('/home/wxiong/seer_remote/ecg_data_result_PNES/RRI_ch31_rawauto_ACT0128_15s_3h.csv',sep=',',header=None)
# Raw_variance_EEG= csv_reader.values
# Raw_var_EEG_arr=[]
# for item in Raw_variance_EEG:
#     Raw_var_EEG_arr.append(float(item))
...
# # np.savetxt("cycles24h_ch31_forecast72hsignal_3hcycle_RRIauto_ACT0128.csv", fore_arr_EEGvars, delimiter=",", fmt='%s')
#
#     raw_seq = target_arr
...
# np.savetxt("activation_LSTM_Ch31_RRIauto_ACT0128.csv", fore_arr_EEGvars, delimiter=",", fmt='%s')


# from statsmodels.tsa.api import SARIMAX
# csv_reader = pd.read_csv('/home/wxiong/seer_remote/ecg_data_result_PNES/RRI_ch31_rawauto_VIC2835_15s_3h.csv',sep=',',header=None)
# Raw_variance_EEG= csv_reader.values
# Raw_var_EEG_arr=[]
# for item in Raw_variance_EEG:
#     Raw_var_EEG_arr.append(float(item))
...
# np.savetxt("cycles6h_ch31_forecast33hsignal_3hcycle_RRIauto_VIC2835.csv", fore_arr_EEGvars, delimiter=",", fmt='%s')



from statsmodels.tsa.api import SARIMAX
csv_reader = pd.read_csv('/fred/oz132/ECGresult/PNES/RRI_ch31_rawauto_VIC0829_15s_3h.csv',sep=',',header=None)
Raw_variance_EEG= csv_reader.values
Raw_var_EEG_arr=[]
for item in Raw_variance_EEG:
    Raw_var_EEG_arr.append(float(item))
...
np.savetxt("cycles6hd0_ch31_forecast81hsignal_3hcycle_RRIauto_VIC0829.csv", fore_arr_EEGvars, delimiter=",", fmt='%s')




# from statsmodels.tsa.api import SARIMAX
# csv_reader = pd.read_csv('/fred/oz132/ECGresult/PNES/RRI_ch31_rawauto_QLD2307_15s_3h.csv',sep=',',header=None)
# Raw_variance_EEG= csv_reader.values
# Raw_var_EEG_arr=[]
# for item in Raw_variance_EEG:
#     Raw_var_EEG_arr.append(float(item))
...
# np.savetxt("cycles24hd0m72_ch31_forecast81hsignal_3hcycle_RRIauto_QLD2307.csv", fore_arr_EEGvars, delimiter=",", fmt='%s')
...
#     model_fit = model.fit()
#     fore_arr_EEGvars.append(model_fit.predict(288, 305))
# np.savetxt("cycles12hd0m216_ch31_forecast81hsignal_3hcycle_RRIauto_QLD3694.csv", fore_arr_EEGvars, delimiter=",", fmt='%s')


# from statsmodels.tsa.api import SARIMAX
# csv_reader = pd.read_csv('/fred/oz132/ECGresult/PNES/RRI_ch31_rawauto_NSW1402_15s_3h.csv',sep=',',header=None)
# Raw_variance_EEG= csv_reader.values
# Raw_var_EEG_arr=[]
# for item in Raw_variance_EEG:
#     Raw_var_EEG_arr.append(float(item))
...
# np.savetxt("cycles12hd0m72_ch31_forecast63hsignal_3hcycle_RRIauto_NSW1402_2022.csv", fore_arr_EEGvars, delimiter=",", fmt='%s')


# csv_reader = pd.read_csv('/fred/oz132/seer_remote/ecg_data_result_PNES/RRI_ch31_rawauto_SA1243_15s_3h.csv',sep=',',header=None)
# Raw_variance_EEG= csv_reader.values
# Raw_var_EEG_arr=[]
# for item in Raw_variance_EEG:
#     Raw_var_EEG_arr.append(float(item))
...
#     model_fit = model.fit()
#     fore_arr_EEGvars.append(model_fit.predict(450, 467))
# np.savetxt("cycles6hd0_ch31_forecast81hsignal_3hcycle_RRIauto_SA1243_2022.csv", fore_arr_EEGvars, delimiter=",", fmt='%s')
...
# np.savetxt("cycles6h_ch31_forecast72hsignal_3hcycle_RRIauto_ACT0128_2022_new.csv", fore_arr_EEGvars, delimiter=",", fmt='%s')
...
#     model_fit = model.fit()
#     fore_arr_EEGvars.append(model_fit.predict(342, 359))
# np.savetxt("cycles24hd0m72_ch31_forecast81hsignal_3hcycle_RRIvar_QLD2307_2022.csv", fore_arr_EEGvars, delimiter=",", fmt='%s')
...
#     model_fit = model.fit()
#     fore_arr_EEGvars.append(model_fit.predict(450, 467))
# np.savetxt("cycles6hd0m216_ch31_forecast81hsignal_3hcycle_RRIauto_SA1243_2022.csv", fore_arr_EEGvars, delimiter=",", fmt='%s')
...
#     model_fit = model.fit()
#     fore_arr_EEGvars.append(model_fit.predict(396, 413))
# np.savetxt("cycles12hd0m216_ch31_forecast78hsignal_3hcycle_RRIauto_WA0305_2022.csv", fore_arr_EEGvars, delimiter=",", fmt='%s')
