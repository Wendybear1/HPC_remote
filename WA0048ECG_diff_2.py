...
#
#
# np.savetxt("rawRRI_ch21_SA0124_15s_3h.csv", RRI_arr31_arr, delimiter=",", fmt='%s')
# np.savetxt("rawRRI_ch21_timearr_SA0124_15s_3h.csv", t_arr31, delimiter=",", fmt='%s')
# np.savetxt("RRI_ch21_timewindowarr_SA0124_15s_3h.csv", t_window_arr, delimiter=",", fmt='%s')
# np.savetxt("RRI_ch21_rawvariance_SA0124_15s_3h.csv", variance_arr, delimiter=",", fmt='%s')
# np.savetxt("RRI_ch21_rawauto_SA0124_15s_3h.csv", value_arr, delimiter=",", fmt='%s')
# np.savetxt("RRI_ch21_rawautolag1_SA0124_15s_3h.csv", value_lag_arr, delimiter=",", fmt='%s')
...
#
#
# np.savetxt("rawRRI_ch31_VIC0821_15s_3h.csv", RRI_arr31_arr, delimiter=",", fmt='%s')
# np.savetxt("rawRRI_ch31_timearr_VIC0821_15s_3h.csv", t_arr31, delimiter=",", fmt='%s')
# np.savetxt("RRI_ch31_timewindowarr_VIC0821_15s_3h.csv", t_window_arr, delimiter=",", fmt='%s')
# np.savetxt("RRI_ch31_rawvariance_VIC0821_15s_3h.csv", variance_arr, delimiter=",", fmt='%s')
# np.savetxt("RRI_ch31_rawauto_VIC0821_15s_3h.csv", value_arr, delimiter=",", fmt='%s')
# np.savetxt("RRI_ch31_rawautolag1_VIC0821_15s_3h.csv", value_lag_arr, delimiter=",", fmt='%s')
