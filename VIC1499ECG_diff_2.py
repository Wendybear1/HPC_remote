...
# value_arr=[]
# variance_arr=[]
# directory = r'/fred/oz132/QLD3694'
#
#
...
#
# np.savetxt("rawRRI_ch31_QLD3694_15s_3h.csv", RRI_arr31_arr, delimiter=",", fmt='%s')
# np.savetxt("rawRRI_ch31_timearr_QLD3694_15s_3h.csv", t_arr31, delimiter=",", fmt='%s')
# np.savetxt("RRI_ch31_timewindowarr_QLD3694_15s_3h.csv", t_window_arr, delimiter=",", fmt='%s')
# np.savetxt("RRI_ch31_rawvariance_QLD3694_15s_3h.csv", variance_arr, delimiter=",", fmt='%s')
# np.savetxt("RRI_ch31_rawauto_QLD3694_15s_3h.csv", value_arr, delimiter=",", fmt='%s')
...
value_arr=[]
variance_arr=[]
directory = r'/fred/oz132/Download/VIC2835'
...
np.savetxt("rawRRI_ch31_VIC2835_15s_3h.csv", RRI_arr31_arr, delimiter=",", fmt='%s')
np.savetxt("rawRRI_ch31_timearr_VIC2835_15s_3h.csv", t_arr31, delimiter=",", fmt='%s')
np.savetxt("RRI_ch31_timewindowarr_VIC2835_15s_3h.csv", t_window_arr, delimiter=",", fmt='%s')
np.savetxt("RRI_ch31_rawvariance_VIC2835_15s_3h.csv", variance_arr, delimiter=",", fmt='%s')
np.savetxt("RRI_ch31_rawauto_VIC2835_15s_3h.csv", value_arr, delimiter=",", fmt='%s')
np.savetxt("RRI_ch31_rawautolag1_VIC2835_15s_3h.csv", value_lag_arr, delimiter=",", fmt='%s')
...
np.savetxt("rawRRI_ch21_VIC2835_15s_3h.csv", RRI_arr31_arr, delimiter=",", fmt='%s')
np.savetxt("rawRRI_ch21_timearr_VIC2835_15s_3h.csv", t_arr31, delimiter=",", fmt='%s')
np.savetxt("RRI_ch21_timewindowarr_VIC2835_15s_3h.csv", t_window_arr, delimiter=",", fmt='%s')
np.savetxt("RRI_ch21_rawvariance_VIC2835_15s_3h.csv", variance_arr, delimiter=",", fmt='%s')
np.savetxt("RRI_ch21_rawauto_VIC2835_15s_3h.csv", value_arr, delimiter=",", fmt='%s')
np.savetxt("RRI_ch21_rawautolag1_VIC2835_15s_3h.csv", value_lag_arr, delimiter=",", fmt='%s')
